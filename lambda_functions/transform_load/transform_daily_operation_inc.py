...
def process_file(bucket_name, csv_file_key):
    try:
        ...
        daily_df['respondent_date'] = daily_df['respondent']+"_"+daily_df['timestamp']
        daily_df['fueltype_timezone'] = daily_df['fueltype']+"_"+daily_df['timezone']
...
def lambda_handler(event, context):   
    ...
    for record in event.get("Records", []):
        ...
        if csv_file_key.startswith("incremental/daily_electricity_data_"):
