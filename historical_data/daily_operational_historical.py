...
for year in years_to_fetch:
    ...
    operational_daily_df = fetch_data(api_ops_daily, API_KEY, headers)
    ...
    local_path = f'historical_daily_operations_{year}.parquet'
    s3_path = f'historical/daily_operations_{year}_data.parquet'
    
    operational_daily_df.to_parquet(
        local_path,
        engine='pyarrow',
        compression='snappy',
        index=False
