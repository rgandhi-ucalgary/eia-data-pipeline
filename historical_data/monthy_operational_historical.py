...
for year in years_to_fetch:
    ...
    operational_monthly_df = fetch_data(api_ops_monthly, API_KEY, headers)
    ...
    local_path = f'historical_monthly_operations_{year}.parquet'
    s3_path = f'historical/monthly_operations_{year}_data.parquet'
    
    operational_monthly_df.to_parquet(
        local_path,
        engine='pyarrow',
        compression='snappy',
        index=False
